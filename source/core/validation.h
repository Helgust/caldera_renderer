...
static const char* VL_VALIDATION_DEBUG_ACTION_VK_DBG_LAYER_ACTION_LOG_MSG =
  "VK_DBG_LAYER_ACTION_LOG_MSG";
static const char* VL_VALIDATION_DEBUG_ACTION_VK_DBG_LAYER_ACTION_DEBUG_OUTPUT =
  "VK_DBG_LAYER_ACTION_DEBUG_OUTPUT";
static const char* VL_VALIDATION_DEBUG_ACTION_VK_DBG_LAYER_ACTION_BREAK =
...
struct ValidationSettingData {
  ...
  // - int32_t printf_buffer_size = 2048;
  ...
  // This setting requires ALL of the following values:
  // - VkBool32 printf_enable = VK_TRUE;
  VkBool32 printf_to_stdout = VK_FALSE;
  ...
  // This setting requires ALL of the following values:
  // - VkBool32 printf_enable = VK_TRUE;
  uint32_t printf_buffer_size = 2048;
  ...
  std::vector<std::string> debug_action = {
    VL_VALIDATION_DEBUG_ACTION_VK_DBG_LAYER_ACTION_LOG_MSG,
    VL_VALIDATION_DEBUG_ACTION_VK_DBG_LAYER_ACTION_DEBUG_OUTPUT};

  // Log Filename
  // ------------------------------------------
  // log_filename (WINDOWS_X86, WINDOWS_ARM, LINUX, MACOS, ANDROID)
  // Specifies the output filename
  std::string log_filename = "validation.log";
  ...
  std::vector<std::string> report_flags = {VL_VALIDATION_REPORT_FLAGS_ERROR,
                                           VL_VALIDATION_REPORT_FLAGS_PERF,
                                           VL_VALIDATION_REPORT_FLAGS_WARN};
  ...
  // This setting requires ALL of the following values:
  // - VkBool32 enable_message_limit = VK_TRUE;
  uint32_t duplicate_message_limit = 10;
 ...
 private:
  ...
  void init() {
    this->gpuav_shaders_to_instrument_info.resize(
      this->gpuav_shaders_to_instrument.size());
    for (std::size_t i = 0, n = gpuav_shaders_to_instrument_info.size(); i < n;
         ++i) {
      this->gpuav_shaders_to_instrument_info[i] =
        this->gpuav_shaders_to_instrument[i].c_str();
    }
...
struct CrashdiagnosticSettingData {
  ...
  std::string dump_queue_submits =
    VL_CRASH_DIAGNOSTIC_DUMP_QUEUE_SUBMITS_RUNNING;
  ...
  std::string dump_command_buffers =
    VL_CRASH_DIAGNOSTIC_DUMP_COMMAND_BUFFERS_RUNNING;
  ...
  // reported.
  // This setting can list multiple values using the "," (comma) separator.
  std::vector<std::string> message_severity = {
    VL_CRASH_DIAGNOSTIC_MESSAGE_SEVERITY_ERROR};
...
static const char* VL_GFXRECONSTRUCT_MEMORY_TRACKING_MODE_PAGE_GUARD =
  "page_guard";
static const char* VL_GFXRECONSTRUCT_MEMORY_TRACKING_MODE_ASSISTED = "assisted";
static const char* VL_GFXRECONSTRUCT_MEMORY_TRACKING_MODE_UNASSISTED =
  "unassisted";
...
struct GfxreconstructSettingData {
  ...
  std::string capture_compression_type =
    VL_GFXRECONSTRUCT_CAPTURE_COMPRESSION_TYPE_LZ4;
  ...
  std::string memory_tracking_mode =
    VL_GFXRECONSTRUCT_MEMORY_TRACKING_MODE_PAGE_GUARD;
...
static const char* VL_SCREENSHOT_FORMAT_USE_SWAPCHAIN_COLORSPACE =
...
static const char* VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_API_VERSION_BIT =
  "SIMULATE_API_VERSION_BIT";
static const char* VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_FEATURES_BIT =
  "SIMULATE_FEATURES_BIT";
static const char* VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_PROPERTIES_BIT =
  "SIMULATE_PROPERTIES_BIT";
static const char* VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_EXTENSIONS_BIT =
  "SIMULATE_EXTENSIONS_BIT";
static const char* VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_FORMATS_BIT =
  "SIMULATE_FORMATS_BIT";
static const char*
  VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_VIDEO_CAPABILITIES_BIT =
    "SIMULATE_VIDEO_CAPABILITIES_BIT";
static const char*
  VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_VIDEO_FORMATS_BIT =
    "SIMULATE_VIDEO_FORMATS_BIT";

// Possible values for `VK_LAYER_KHRONOS_profiles` layer `default_feature_values` setting:
static const char*
  VL_PROFILES_DEFAULT_FEATURE_VALUES_DEFAULT_FEATURE_VALUES_DEVICE =
    "DEFAULT_FEATURE_VALUES_DEVICE";
static const char*
  VL_PROFILES_DEFAULT_FEATURE_VALUES_DEFAULT_FEATURE_VALUES_FALSE =
    "DEFAULT_FEATURE_VALUES_FALSE";

// Possible values for `VK_LAYER_KHRONOS_profiles` layer `unknown_feature_values` setting:
static const char*
  VL_PROFILES_UNKNOWN_FEATURE_VALUES_UNKNOWN_FEATURE_VALUES_UNCHANGED =
    "UNKNOWN_FEATURE_VALUES_UNCHANGED";
static const char*
  VL_PROFILES_UNKNOWN_FEATURE_VALUES_UNKNOWN_FEATURE_VALUES_DEVICE =
    "UNKNOWN_FEATURE_VALUES_DEVICE";

// Possible values for VK_LAYER_KHRONOS_profiles layer debug_actions setting:
static const char* VL_PROFILES_DEBUG_ACTIONS_DEBUG_ACTION_STDOUT_BIT =
  "DEBUG_ACTION_STDOUT_BIT";
static const char* VL_PROFILES_DEBUG_ACTIONS_DEBUG_ACTION_OUTPUT_BIT =
  "DEBUG_ACTION_OUTPUT_BIT";
static const char* VL_PROFILES_DEBUG_ACTIONS_DEBUG_ACTION_FILE_BIT =
  "DEBUG_ACTION_FILE_BIT";
static const char* VL_PROFILES_DEBUG_ACTIONS_DEBUG_ACTION_BREAKPOINT_BIT =
  "DEBUG_ACTION_BREAKPOINT_BIT";

// Possible values for VK_LAYER_KHRONOS_profiles layer debug_reports setting:
static const char* VL_PROFILES_DEBUG_REPORTS_DEBUG_REPORT_NOTIFICATION_BIT =
  "DEBUG_REPORT_NOTIFICATION_BIT";
static const char* VL_PROFILES_DEBUG_REPORTS_DEBUG_REPORT_WARNING_BIT =
  "DEBUG_REPORT_WARNING_BIT";
static const char* VL_PROFILES_DEBUG_REPORTS_DEBUG_REPORT_ERROR_BIT =
  "DEBUG_REPORT_ERROR_BIT";
static const char* VL_PROFILES_DEBUG_REPORTS_DEBUG_REPORT_DEBUG_BIT =
...
struct ProfilesSettingData {
  ...
  // This setting can list multiple values using the "," (comma) separator.
  std::vector<std::string> simulate_capabilities = {
    VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_API_VERSION_BIT,
    VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_FEATURES_BIT,
    VL_PROFILES_SIMULATE_CAPABILITIES_SIMULATE_PROPERTIES_BIT};
  ...
  std::string default_feature_values =
    VL_PROFILES_DEFAULT_FEATURE_VALUES_DEFAULT_FEATURE_VALUES_DEVICE;
  ...
  std::string unknown_feature_values =
    VL_PROFILES_UNKNOWN_FEATURE_VALUES_UNKNOWN_FEATURE_VALUES_UNCHANGED;
  ...
  // information
  // This setting can list multiple values using the "," (comma) separator.
  std::vector<std::string> debug_actions = {
    VL_PROFILES_DEBUG_ACTIONS_DEBUG_ACTION_STDOUT_BIT};
  ...
  // This setting can list multiple values using the "," (comma) separator.
  std::vector<std::string> debug_reports = {
    VL_PROFILES_DEBUG_REPORTS_DEBUG_REPORT_NOTIFICATION_BIT,
    VL_PROFILES_DEBUG_REPORTS_DEBUG_REPORT_WARNING_BIT,
    VL_PROFILES_DEBUG_REPORTS_DEBUG_REPORT_ERROR_BIT};
 ...
 private:
  ...
  void init() {
    ...
    for (std::size_t i = 0, n = simulate_capabilities_info.size(); i < n; ++i) {
      this->simulate_capabilities_info[i] =
        this->simulate_capabilities[i].c_str();
    }
    this->exclude_device_extensions_info.resize(
      this->exclude_device_extensions.size());
    for (std::size_t i = 0, n = exclude_device_extensions_info.size(); i < n;
         ++i) {
      this->exclude_device_extensions_info[i] =
        this->exclude_device_extensions[i].c_str();
    }
...
struct LayerSettings {
  ...
  std::vector<VkLayerSettingEXT> info() {
    ...
    std::vector<VkLayerSettingEXT> init{
      {"VK_LAYER_KHRONOS_validation", "fine_grained_locking",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.fine_grained_locking},
      {"VK_LAYER_KHRONOS_validation", "validate_core",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.validate_core},
      {"VK_LAYER_KHRONOS_validation", "check_image_layout",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.check_image_layout},
      {"VK_LAYER_KHRONOS_validation", "check_command_buffer",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.check_command_buffer},
      {"VK_LAYER_KHRONOS_validation", "check_object_in_use",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.check_object_in_use},
      {"VK_LAYER_KHRONOS_validation", "check_query",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.check_query},
      {"VK_LAYER_KHRONOS_validation", "check_shaders",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.check_shaders},
      {"VK_LAYER_KHRONOS_validation", "check_shaders_caching",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.check_shaders_caching},
      {"VK_LAYER_KHRONOS_validation", "unique_handles",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.unique_handles},
      {"VK_LAYER_KHRONOS_validation", "object_lifetime",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.object_lifetime},
      {"VK_LAYER_KHRONOS_validation", "stateless_param",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.stateless_param},
      {"VK_LAYER_KHRONOS_validation", "legacy_detection",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.legacy_detection},
      {"VK_LAYER_KHRONOS_validation", "thread_safety",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.thread_safety},
      {"VK_LAYER_KHRONOS_validation", "validate_sync",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.validate_sync},
      {"VK_LAYER_KHRONOS_validation", "syncval_submit_time_validation",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.syncval_submit_time_validation},
      {"VK_LAYER_KHRONOS_validation", "syncval_shader_accesses_heuristic",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.syncval_shader_accesses_heuristic},
      {"VK_LAYER_KHRONOS_validation", "syncval_message_extra_properties",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.syncval_message_extra_properties},
      {"VK_LAYER_KHRONOS_validation", "printf_only_preset",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.printf_only_preset},
      {"VK_LAYER_KHRONOS_validation", "printf_enable",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.printf_enable},
      {"VK_LAYER_KHRONOS_validation", "printf_to_stdout",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.printf_to_stdout},
      {"VK_LAYER_KHRONOS_validation", "printf_verbose",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.printf_verbose},
      {"VK_LAYER_KHRONOS_validation", "printf_buffer_size",
       VK_LAYER_SETTING_TYPE_UINT32_EXT, 1,
       &this->validation.printf_buffer_size},
      {"VK_LAYER_KHRONOS_validation", "gpuav_enable",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.gpuav_enable},
      {"VK_LAYER_KHRONOS_validation", "gpuav_safe_mode",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->validation.gpuav_safe_mode},
      {"VK_LAYER_KHRONOS_validation", "gpuav_force_on_robustness",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_force_on_robustness},
      {"VK_LAYER_KHRONOS_validation", "gpuav_shader_instrumentation",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_shader_instrumentation},
      {"VK_LAYER_KHRONOS_validation", "gpuav_select_instrumented_shaders",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_select_instrumented_shaders},
      {"VK_LAYER_KHRONOS_validation", "gpuav_shaders_to_instrument",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(
         this->validation.gpuav_shaders_to_instrument_info.size()),
       this->validation.gpuav_shaders_to_instrument_info.data()},
      {"VK_LAYER_KHRONOS_validation", "gpuav_descriptor_checks",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_descriptor_checks},
      {"VK_LAYER_KHRONOS_validation", "gpuav_post_process_descriptor_indexing",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_post_process_descriptor_indexing},
      {"VK_LAYER_KHRONOS_validation", "gpuav_buffer_address_oob",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_buffer_address_oob},
      {"VK_LAYER_KHRONOS_validation", "gpuav_mesh_shading",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_mesh_shading},
      {"VK_LAYER_KHRONOS_validation", "gpuav_validate_ray_query",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_validate_ray_query},
      {"VK_LAYER_KHRONOS_validation", "gpuav_vertex_attribute_fetch_oob",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_vertex_attribute_fetch_oob},
      {"VK_LAYER_KHRONOS_validation", "gpuav_shader_sanitizer",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_shader_sanitizer},
      {"VK_LAYER_KHRONOS_validation", "gpuav_buffers_validation",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_buffers_validation},
      {"VK_LAYER_KHRONOS_validation", "gpuav_indirect_draws_buffers",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_indirect_draws_buffers},
      {"VK_LAYER_KHRONOS_validation", "gpuav_indirect_dispatches_buffers",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_indirect_dispatches_buffers},
      {"VK_LAYER_KHRONOS_validation", "gpuav_indirect_trace_rays_buffers",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_indirect_trace_rays_buffers},
      {"VK_LAYER_KHRONOS_validation", "gpuav_buffer_copies",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_buffer_copies},
      {"VK_LAYER_KHRONOS_validation", "gpuav_copy_memory_indirect",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_copy_memory_indirect},
      {"VK_LAYER_KHRONOS_validation", "gpuav_index_buffers",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_index_buffers},
      {"VK_LAYER_KHRONOS_validation", "gpuav_acceleration_structures_builds",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.gpuav_acceleration_structures_builds},
      {"VK_LAYER_KHRONOS_validation", "validate_best_practices",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.validate_best_practices},
      {"VK_LAYER_KHRONOS_validation", "validate_best_practices_arm",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.validate_best_practices_arm},
      {"VK_LAYER_KHRONOS_validation", "validate_best_practices_amd",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.validate_best_practices_amd},
      {"VK_LAYER_KHRONOS_validation", "validate_best_practices_img",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.validate_best_practices_img},
      {"VK_LAYER_KHRONOS_validation", "validate_best_practices_nvidia",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.validate_best_practices_nvidia},
      {"VK_LAYER_KHRONOS_validation", "debug_action",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(this->validation.debug_action_info.size()),
       this->validation.debug_action_info.data()},
      {"VK_LAYER_KHRONOS_validation", "log_filename",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->validation.log_filename.c_str()},
      {"VK_LAYER_KHRONOS_validation", "report_flags",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(this->validation.report_flags_info.size()),
       this->validation.report_flags_info.data()},
      {"VK_LAYER_KHRONOS_validation", "enable_message_limit",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.enable_message_limit},
      {"VK_LAYER_KHRONOS_validation", "duplicate_message_limit",
       VK_LAYER_SETTING_TYPE_UINT32_EXT, 1,
       &this->validation.duplicate_message_limit},
      {"VK_LAYER_KHRONOS_validation", "message_id_filter",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(this->validation.message_id_filter_info.size()),
       this->validation.message_id_filter_info.data()},
      {"VK_LAYER_KHRONOS_validation", "message_format_json",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.message_format_json},
      {"VK_LAYER_KHRONOS_validation", "message_format_display_application_name",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->validation.message_format_display_application_name},
      {"VK_LAYER_LUNARG_api_dump", "output_range",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->api_dump.output_range.c_str()},
      {"VK_LAYER_LUNARG_api_dump", "output_format",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->api_dump.output_format.c_str()},
      {"VK_LAYER_LUNARG_api_dump", "pre_dump", VK_LAYER_SETTING_TYPE_BOOL32_EXT,
       1, &this->api_dump.pre_dump},
      {"VK_LAYER_LUNARG_api_dump", "file", VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->api_dump.file},
      {"VK_LAYER_LUNARG_api_dump", "log_filename",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->api_dump.log_filename.c_str()},
      {"VK_LAYER_LUNARG_api_dump", "flush", VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->api_dump.flush},
      {"VK_LAYER_LUNARG_api_dump", "name_size", VK_LAYER_SETTING_TYPE_INT32_EXT,
       1, &this->api_dump.name_size},
      {"VK_LAYER_LUNARG_api_dump", "show_types",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->api_dump.show_types},
      {"VK_LAYER_LUNARG_api_dump", "type_size", VK_LAYER_SETTING_TYPE_INT32_EXT,
       1, &this->api_dump.type_size},
      {"VK_LAYER_LUNARG_api_dump", "timestamp",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->api_dump.timestamp},
      {"VK_LAYER_LUNARG_api_dump", "show_shader",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->api_dump.show_shader},
      {"VK_LAYER_LUNARG_api_dump", "detailed", VK_LAYER_SETTING_TYPE_BOOL32_EXT,
       1, &this->api_dump.detailed},
      {"VK_LAYER_LUNARG_api_dump", "no_addr", VK_LAYER_SETTING_TYPE_BOOL32_EXT,
       1, &this->api_dump.no_addr},
      {"VK_LAYER_LUNARG_api_dump", "use_spaces",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->api_dump.use_spaces},
      {"VK_LAYER_LUNARG_api_dump", "indent_size",
       VK_LAYER_SETTING_TYPE_INT32_EXT, 1, &this->api_dump.indent_size},
      {"VK_LAYER_LUNARG_api_dump", "show_thread_and_frame",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->api_dump.show_thread_and_frame},
      {"VK_LAYER_LUNARG_crash_diagnostic", "sync_after_commands",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->crash_diagnostic.sync_after_commands},
      {"VK_LAYER_LUNARG_crash_diagnostic", "instrument_all_commands",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->crash_diagnostic.instrument_all_commands},
      {"VK_LAYER_LUNARG_crash_diagnostic", "output_path",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->crash_diagnostic.output_path.c_str()},
      {"VK_LAYER_LUNARG_crash_diagnostic", "trigger_watchdog_timeout",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->crash_diagnostic.trigger_watchdog_timeout},
      {"VK_LAYER_LUNARG_crash_diagnostic", "watchdog_timeout_ms",
       VK_LAYER_SETTING_TYPE_INT32_EXT, 1,
       &this->crash_diagnostic.watchdog_timeout_ms},
      {"VK_LAYER_LUNARG_crash_diagnostic", "track_semaphores",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->crash_diagnostic.track_semaphores},
      {"VK_LAYER_LUNARG_crash_diagnostic", "dump_queue_submits",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->crash_diagnostic.dump_queue_submits.c_str()},
      {"VK_LAYER_LUNARG_crash_diagnostic", "dump_command_buffers",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->crash_diagnostic.dump_command_buffers.c_str()},
      {"VK_LAYER_LUNARG_crash_diagnostic", "dump_commands",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->crash_diagnostic.dump_commands.c_str()},
      {"VK_LAYER_LUNARG_crash_diagnostic", "dump_shaders",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->crash_diagnostic.dump_shaders.c_str()},
      {"VK_LAYER_LUNARG_crash_diagnostic", "log_file",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->crash_diagnostic.log_file.c_str()},
      {"VK_LAYER_LUNARG_crash_diagnostic", "trace_on",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->crash_diagnostic.trace_on},
      {"VK_LAYER_LUNARG_crash_diagnostic", "trace_all_semaphores",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->crash_diagnostic.trace_all_semaphores},
      {"VK_LAYER_LUNARG_crash_diagnostic", "message_severity",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(
         this->crash_diagnostic.message_severity_info.size()),
       this->crash_diagnostic.message_severity_info.data()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_trigger",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.capture_trigger.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_trigger_frames",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.capture_trigger_frames.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_frames",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.capture_frames.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_process_name",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.capture_process_name.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_file",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.capture_file.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_file_timestamp",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.capture_file_timestamp},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_file_flush",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.capture_file_flush},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_compression_type",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.capture_compression_type.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "capture_environment",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(
         this->gfxreconstruct.capture_environment_info.size()),
       this->gfxreconstruct.capture_environment_info.data()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "memory_tracking_mode",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.memory_tracking_mode.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "page_guard_copy_on_map",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.page_guard_copy_on_map},
      {"VK_LAYER_LUNARG_gfxreconstruct", "page_guard_separate_read",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.page_guard_separate_read},
      {"VK_LAYER_LUNARG_gfxreconstruct", "page_guard_external_memory",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.page_guard_external_memory},
      {"VK_LAYER_LUNARG_gfxreconstruct", "page_guard_persistent_memory",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.page_guard_persistent_memory},
      {"VK_LAYER_LUNARG_gfxreconstruct", "page_guard_align_buffer_sizes",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.page_guard_align_buffer_sizes},
      {"VK_LAYER_LUNARG_gfxreconstruct", "page_guard_unblock_sigsegv",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.page_guard_unblock_sigsegv},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_level",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.log_level.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_detailed",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->gfxreconstruct.log_detailed},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_allow_indents",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.log_allow_indents},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_output_to_console",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.log_output_to_console},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_break_on_error",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.log_break_on_error},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_output_to_os_debug_string",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.log_output_to_os_debug_string},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_file",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->gfxreconstruct.log_file.c_str()},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_file_flush_after_write",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.log_file_flush_after_write},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_file_keep_open",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.log_file_keep_open},
      {"VK_LAYER_LUNARG_gfxreconstruct", "log_file_create_new",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->gfxreconstruct.log_file_create_new},
      {"VK_LAYER_LUNARG_screenshot", "frames", VK_LAYER_SETTING_TYPE_STRING_EXT,
       1, this->screenshot.frames.c_str()},
      {"VK_LAYER_LUNARG_screenshot", "dir", VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->screenshot.dir.c_str()},
      {"VK_LAYER_LUNARG_screenshot", "format", VK_LAYER_SETTING_TYPE_STRING_EXT,
       1, this->screenshot.format.c_str()},
      {"VK_LAYER_KHRONOS_profiles", "profile_emulation",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->profiles.profile_emulation},
      {"VK_LAYER_KHRONOS_profiles", "profile_dirs",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->profiles.profile_dirs.c_str()},
      {"VK_LAYER_KHRONOS_profiles", "profile_name",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->profiles.profile_name.c_str()},
      {"VK_LAYER_KHRONOS_profiles", "profile_validation",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->profiles.profile_validation},
      {"VK_LAYER_KHRONOS_profiles", "simulate_capabilities",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(this->profiles.simulate_capabilities_info.size()),
       this->profiles.simulate_capabilities_info.data()},
      {"VK_LAYER_KHRONOS_profiles", "default_feature_values",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->profiles.default_feature_values.c_str()},
      {"VK_LAYER_KHRONOS_profiles", "unknown_feature_values",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->profiles.unknown_feature_values.c_str()},
      {"VK_LAYER_KHRONOS_profiles", "emulate_portability",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.emulate_portability},
      {"VK_LAYER_KHRONOS_profiles", "constantAlphaColorBlendFactors",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.constantAlphaColorBlendFactors},
      {"VK_LAYER_KHRONOS_profiles", "events", VK_LAYER_SETTING_TYPE_BOOL32_EXT,
       1, &this->profiles.events},
      {"VK_LAYER_KHRONOS_profiles", "imageViewFormatReinterpretation",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.imageViewFormatReinterpretation},
      {"VK_LAYER_KHRONOS_profiles", "imageViewFormatSwizzle",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.imageViewFormatSwizzle},
      {"VK_LAYER_KHRONOS_profiles", "imageView2DOn3DImage",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.imageView2DOn3DImage},
      {"VK_LAYER_KHRONOS_profiles", "multisampleArrayImage",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.multisampleArrayImage},
      {"VK_LAYER_KHRONOS_profiles", "mutableComparisonSamplers",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.mutableComparisonSamplers},
      {"VK_LAYER_KHRONOS_profiles", "pointPolygons",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->profiles.pointPolygons},
      {"VK_LAYER_KHRONOS_profiles", "samplerMipLodBias",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->profiles.samplerMipLodBias},
      {"VK_LAYER_KHRONOS_profiles", "separateStencilMaskRef",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.separateStencilMaskRef},
      {"VK_LAYER_KHRONOS_profiles", "shaderSampleRateInterpolationFunctions",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.shaderSampleRateInterpolationFunctions},
      {"VK_LAYER_KHRONOS_profiles", "tessellationIsolines",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.tessellationIsolines},
      {"VK_LAYER_KHRONOS_profiles", "triangleFans",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->profiles.triangleFans},
      {"VK_LAYER_KHRONOS_profiles", "vertexAttributeAccessBeyondStride",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.vertexAttributeAccessBeyondStride},
      {"VK_LAYER_KHRONOS_profiles", "minVertexInputBindingStrideAlignment",
       VK_LAYER_SETTING_TYPE_INT32_EXT, 1,
       &this->profiles.minVertexInputBindingStrideAlignment},
      {"VK_LAYER_KHRONOS_profiles", "exclude_device_extensions",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(
         this->profiles.exclude_device_extensions_info.size()),
       this->profiles.exclude_device_extensions_info.data()},
      {"VK_LAYER_KHRONOS_profiles", "exclude_formats",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(this->profiles.exclude_formats_info.size()),
       this->profiles.exclude_formats_info.data()},
      {"VK_LAYER_KHRONOS_profiles", "debug_actions",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(this->profiles.debug_actions_info.size()),
       this->profiles.debug_actions_info.data()},
      {"VK_LAYER_KHRONOS_profiles", "debug_filename",
       VK_LAYER_SETTING_TYPE_STRING_EXT, 1,
       this->profiles.debug_filename.c_str()},
      {"VK_LAYER_KHRONOS_profiles", "debug_file_clear",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->profiles.debug_file_clear},
      {"VK_LAYER_KHRONOS_profiles", "debug_fail_on_error",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->profiles.debug_fail_on_error},
      {"VK_LAYER_KHRONOS_profiles", "debug_reports",
       VK_LAYER_SETTING_TYPE_STRING_EXT,
       static_cast<uint32_t>(this->profiles.debug_reports_info.size()),
       this->profiles.debug_reports_info.data()},
      {"VK_LAYER_KHRONOS_shader_object", "force_enable",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1, &this->shader_object.force_enable},
      {"VK_LAYER_KHRONOS_shader_object", "disable_pipeline_pre_caching",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->shader_object.disable_pipeline_pre_caching},
      {"VK_LAYER_KHRONOS_synchronization2", "force_enable",
       VK_LAYER_SETTING_TYPE_BOOL32_EXT, 1,
       &this->synchronization2.force_enable},
    };
    return init;
  };
};
